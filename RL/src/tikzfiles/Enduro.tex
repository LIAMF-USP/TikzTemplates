...
\begin{scope}[xshift=0cm,yshift=0cm]
            \begin{scope}[xshift=0cm,yshift=0cm]
            \node (x1) at (1,1) {\includegraphics[width=.35\textwidth]{images/enduro.png}};
            \end{scope}
            \begin{scope}[xshift=-0.6cm,yshift=-0.6cm]
            \node (x2)  at (1,1) {\includegraphics[width=.35\textwidth]{images/enduro.png}};
            \end{scope}
            \begin{scope}[xshift=-1.2cm,yshift=-1.2cm]
            \node (x3)  at (1,1) {\includegraphics[width=.35\textwidth]{images/enduro.png}};
            \end{scope}  
\end{scope}
